...
import PendingPayment from "@/components/pages/PendingPayment";
...
// PendingPaymentPage component - Wrapper that provides sidebar layout
const PendingPaymentPage = () => {
  ...
  return (
    <DashboardLayout sidebarItems={getSidebarItems()} userType={userType || "family"}>
      <PendingPayment isEmbedded={true} />
    </DashboardLayout>
  );
};
